...
public class XtraReport1 : DevExpress.XtraReports.UI.XtraReport
{
	...
	private void InitializeComponent() {
        ...
        this.xrLabel5.Location = new System.Drawing.Point(275, 8);
    ...
    public Hashtable skippedDetailBands = new Hashtable();
    ...
    private void DetailReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
    {
        ...
        if (skippedDetailBands.Contains(catid.ToString()))
    ...
    {    
        ...
        if (skippedDetailBands.Contains(catid.ToString()) && (bool)skippedDetailBands[catid.ToString()] == true)
            label.Text = "+";
        else
            label.Text = "-";
